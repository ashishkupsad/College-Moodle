...
$_SESSION['course_code'] = $course_code;
    ...
    ?>
    <a href="ins_submissions_view.php">Evaluate submissions</a>
...
<?php
    ...
    #echo '<a href="../add/add_assignment_form.php?user_id='.$user_id.'&course_code='.$course_code.'">Add assignment</a> </br>';
